...
| Version | Commit | What |
|---------|--------|------|
| v0.13.5 | `69aabd5` | (Codex) Authoritative DraftSheets replace-mode import: `replace=true` clears only the requested source+season, runs delete+insert in one transaction, and refuses suspiciously small parsed/mapped row counts before commit. |
