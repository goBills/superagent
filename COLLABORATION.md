...
| Version | Commit | What |
|---------|--------|------|
| v0.14.0 | `08f2858` | (Codex) 2026 source-agnostic board foundation: expanded Sleeper identity seeding and new Sleeper ADP ingester/admin endpoint writing `DraftPlayerMarket(source="sleeper_adp", season=2026)`. |
