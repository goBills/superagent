...
| Version | Commit | What |
|---------|--------|------|
| v0.13.1 | `7027192` | (Codex) Backend defense-in-depth for bulk paste: `/draft/picks/bulk` skips unchanged existing picks before name resolution; identical over-sends no longer hit the resolver, changed same-slot picks still update, and own-pick roster repair still runs. |
